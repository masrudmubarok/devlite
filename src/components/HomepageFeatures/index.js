...
const FeatureList = [
  {
    ...
    description: (
      <>
        ...
        Devlite is a software development learning platform that adopts a unique ninja-style approach. We believe that becoming a great software developer takes more than just technical skills it requires discipline, perseverance, and a strategic mindset, just like a ninja mastering their craft.
        </p>
        <p className={styles.justifyText}>
